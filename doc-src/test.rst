...
If you have :code:`sudo`, the tests will not make use of it by default. To
enable the tests that use :code:`sudo` if you have privileges, use
:code:`ch-test --sudo` or set :code:`CH_TEST_SUDO` to a non-empty string.
