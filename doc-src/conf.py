...
man_pages = [
    ...
    ('ch-build', 'ch-build', u"Build an image and place it in the builder's back-end storage",
     [u'Reid Priedhorsky, Tim Randles, and others'], 1),
    ...
    ('ch-builder2tar', 'ch-builder2tar', u'Flatten a builder image into a Charliecloud image tarball',
     [u'Reid Priedhorsky, Tim Randles, and others'], 1),
    ('ch-grow', 'ch-grow', u'Build an image from a Dockerfile; completely unprivileged.',
     [u'Reid Priedhorsky, Tim Randles, and others'], 1),
