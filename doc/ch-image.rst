...
::
   ...
   $ ch-image [...] export [...] IMAGE_REF IMAGE_OUT
...
:code:`export` knows about these values of :code:`FMT`:
  ...
  :code:`tar`
    ...
    Output tarballs are always gzipped and must end in :code:`.tar.gz`;
    input tarballs can be any compression acceptable to :code:`tar(1)`.

All of these are local formats; :code:`export` does not know how to push
or pull images.
...
:code:`export` tries to save typing by guessing formats when they are
